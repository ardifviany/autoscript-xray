...
# ==================================================
# Link Hosting Kalian
jevlayer_source="raw.githubusercontent.com/lizsvr/cfnfree/main/ssh"
...
curl https://${jevlayer_source}/nginx.conf > /etc/nginx/nginx.conf
curl https://${jevlayer_source}/vps.conf > /etc/nginx/conf.d/vps.conf
...
wget -O /home/vps/public_html/index.html "https://${jevlayer_source}/index.html1"
